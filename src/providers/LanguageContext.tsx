...
const translations: Record<Language, Record<string, string>> = {
  ...
  fa: {
    ...
    "about.title": "من کیم؟",
    "about.p1": "ماهان بالایی فارغ‌التحصیل زیست‌شناسی ورزشی، مربی رسمی فدراسیون بدنسازی و ورزشکار قدرتی با بیش از ۱۷ سال سابقه تمرین است. او دارای مدرک مربیگری در رشته‌های بدنسازی، آمادگی جسمانی و وزنه‌برداری بوده و قهرمان چندین دوره مسابقات پاورلیفتینگ و پرس سینه در استان‌های گیلان، البرز و تهران می‌باشد.",
